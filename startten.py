...
class Instagram:
    ...
    def save_photo_followers(self):
        ...
        while i<followerrs:
            ...
            time.sleep(2)
#sayfanın en sonuna gitmeli scroll uzunluğu ileilgili
    ...
    def save_photo_following(self):
        ...
        followingg=len(open("following.txt").readlines())
        
        follow=open("following.txt","r")#takipçi ettiklerin
        i=0
        while i<followingg:
